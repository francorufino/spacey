...
export const metadata = {
  ...
  description: "Meet the pioneers of first-class interplanetary vacations."
};
  ...
  return (
    <main className="min-h-screen text-white">
      <section className="mx-auto grid max-w-screen-xl items-center gap-12 px-6 py-16 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            SpaceY is a luxury travel company built around one simple idea: visiting another world should feel like a vacation, not a government assignment.
          </p>
        ...
        <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10">
          <Image src="/experience/shuttle-interior.png" alt="Interior of the SpaceY shuttle" fill className="object-cover" priority />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-5 text-xs italic leading-5 text-slate-500">Certain hospitality standards may be adjusted according to environmental survivability.</p>
      </section>
      <ComparisonTable />
    </main>
  );
